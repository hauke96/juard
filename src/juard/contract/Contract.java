...
public class Contract
{
	...
	/**
	 * Checks if the given condition is {@code true} at the end of the method. When it's not, it'll throw a {@link PostconditionFailedException}.
	 * 
	 * @param expression
	 *            An expression to check.
	 */
	public static void Ensure(boolean expression)
	{
		if (!expression)
		{
			throw new PostconditionFailedException("Postcondition was not true.");
		}
	}
